...
namespace Blazor_Project.Shared.Models
{
    ...
    public class OrderItem
    {
        ...
        public virtual MobilePhone MobilePhone { get; set; } = default!;
    ...
    public class  MobilePhoneDbContext : DbContext
    {
        ...
        public DbSet<MobilePhone> MobilePhones { get; set; } = default!;
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<OrderItem>().HasKey(o => new { o.OrderID, o.MobilePhoneID });
        }
    }
}
